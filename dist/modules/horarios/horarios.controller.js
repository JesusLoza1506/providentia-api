...
let HorariosController = class HorariosController {
    ...
    findByCursoDocenteSeccion(cursoDocenteSeccionId) {
        return this.service.findByCursoDocenteSeccion(cursoDocenteSeccionId);
    }
    findByAulaFisica(aulaFisicaId) {
...
__decorate([
    (0, common_1.Get)('curso-docente-seccion/:cursoDocenteSeccionId'),
    __param(0, (0, common_1.Param)('cursoDocenteSeccionId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], HorariosController.prototype, "findByCursoDocenteSeccion", null);
__decorate([
    (0, common_1.Get)('aula-fisica/:aulaFisicaId'),
    __param(0, (0, common_1.Param)('aulaFisicaId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], HorariosController.prototype, "findByAulaFisica", null);
__decorate([
    (0, common_1.Get)(':id'),
