...
let ExamenesService = class ExamenesService {
    ...
    async findOne(id) {
        ...
        if (!item)
            throw new common_1.NotFoundException(`Examen con ID ${id} no encontrado`);
        return item;
    }
    async create(data) {
...
exports.ExamenesService = ExamenesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(examen_entity_1.Examen)),
